<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="FastFoodProject.User.Cart" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove" 
                                ...
                                OnClientClick="return confirm('Вы хотите удалить этот товар из корзины?');">
