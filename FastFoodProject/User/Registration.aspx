<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FastFoodProject.User.Registration" %>
        ...
        function ImagePreview(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#<%=imgUser.ClientID%>').prop('srs', e.target.result)
                        .width(200)
                        .height(200);
                };
                    ...
                    <div class="row pl-4">
                        <div class="btn_box">
                            ...
                            <asp:Label ID="lblAlreadyUser" runat="server" CssClass="pl-3 text-black-100"
                                Text="Already registered? <a href='Login.aspx' class='bagde bagde-info'>Login.here..</a>">
                            </asp:Label>
                        </div>
                    </div>
