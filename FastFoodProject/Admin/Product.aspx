<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="FastFoodProject.Admin.Product" %>
        ...
        function ImagePreview(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#<%=imgProduct.ClientID%>').prop('srs', e.target.result)
                        .width(200)
                        .height(200);
                };
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                            ErrorMessage="Qunatity must non negative" ForeColor="Red" Display="Dynamic"
