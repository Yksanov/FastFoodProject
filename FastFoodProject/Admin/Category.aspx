<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="FastFoodProject.Admin.Category" %>
        ...
        function ImagePreview(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#<%=imgCategory.ClientID%>').prop('srs', e.target.result)
                        .width(200)
                        .height(200);
                };
